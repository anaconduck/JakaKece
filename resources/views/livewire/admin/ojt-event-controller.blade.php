                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-row-reverse bd-highlight">
                                    ...
                                    <a class="btn btn-primary" href="{{ url('/admin/ojt/event/create') }}"
                                        role="button">Tambah Kegiatan</a>
