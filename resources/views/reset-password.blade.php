        ...
        <div class="left">
            ...
            <form method="POST" action="{{ url('/reset-password') }}">
                <div class="form">
                    ...
                    <input name="password" type="password" class="form-field animation a3" placeholder="new password" minlength="8">
                    <input name="password_confirmation" type="password" class="form-field animation a3" placeholder="new password confirmation" minlength="8">
                    <input class="d-none" name="token" value="{{ $token }}"/>
