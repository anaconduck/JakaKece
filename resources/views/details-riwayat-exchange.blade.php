        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 anot">
                    <h1>Riwayat SE <br> {{ $tujuan->nama_universitas }}</h1>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="container left">
                                <div class="link active" data-target="0">
                                    <div class="text">Informasi Universitas</div>
                                </div>
                                <div class="link" data-target="1">
                                    <div class="text">Informasi Mata Kuliah</div>
                                </div>
                        ...
                        <div class="col-md-8">
                            <div class="card" id="0">
                                ...
                                <div class="card-body">
                                    ...
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-7">{{ $tujuan->dalam_negeri?'Dalam Negeri':'Luar Negeri' }}</dd>

                                        <dt class="col-sm-5">File Penjelas</dt>
                                        <dd class="col-sm-7">
                                            <a href="{{ Storage::url($tujuan->file_penjelas) }}">Unduh File Penjelas</a>
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <div class="card d-none" id="2">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center">{{ $tujuan->nama_universitas }}</h5>
                                    <dl class="row">
                                        @foreach (config('app.dokumentasi') as $ind => $fname)
                                        <dt class="col-sm-3">{{ $ind }}</dt>
                                        <dd class="col-sm-9">
                                            <a href="{{ Storage::url($riwayat->file[$ind]) }}">Unduh {{ $fname }}</a>
                                        </dd>
                                        @endforeach
                                        <dt class="col-sm-3 mt-4">Catatan</dt>
