  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li class="selected"><a href="{{ ('exchange') }}">Student Exchange</a></li>
                    ...
                    <ul class="list-group" id="myList">
                      <li class="list-group-item" style="color: black;">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <label for="lomba1" class="">Universitas Brawijaya</label>
                            </div>
                        </div>
                        </li>
                      <li class="list-group-item" style="color: black;">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <label for="lomba2" class="">Institut Teknologi Sumatera</label>
                            </div>
                        </div>
                        </li>
                      <li class="list-group-item" style="color: black;">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <label for="lomba3" class="">Universitas Negeri Malang</label>
                            </div>
                        </div>
                        </li>
                      <li class="list-group-item" style="color: black;">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <label for="lomba4" class="">Universitas Negeri Jakarta</label>
                            </div>
                        </div>
                        </li>
                    </ul>
