        ...
        <div class="col-md-12">
          <div class="section-heading mb-5">
            ...
            <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <a class="btn btn-primary" href="{{ url('/admin/inkubasi/materi/create') }}" role="button">Tambah Materi</a>
          ...
          <div class="default-table table-responsive">
            ...
            <ul class="table-pagination">
                @if ($page > 1)
                    <li><a href="{{ url("/admin/inkubasi/materi")."/".($page-1) }}">Previous</a></li>
                @else
                    <li>Previous</li>
                @endif
              @for ($ind = 1; $ind <= $total;$ind++)
                ...
                @else
                    <li><a href="{{ url("/admin/inkubasi/materi/$ind") }}">{{ $ind }}</a></li>
                @endif
              @endfor
              @if ($page < $total)
                    <li><a href="{{ url("/admin/inkubasi/materi")."/".($page+1) }}">Next</a></li>
                @else
                    <li>Next</li>
                @endif
            </ul>
