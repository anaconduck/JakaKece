                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <input placeholder="Nama Event" class="form-control file" type="text" name="nama_event" value="{{ $event->nama_event }}">
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset>
                                    <label>Max Konversi SKS</label>
                                    <input placeholder="max konversi sks" class="form-control file" type="number"
                                        name="max_konversi_sks" value="{{ $event->max_konversi_sks }}">
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                ...
                                <select name="id_prodi" id="status" required>
                                    @foreach (config('app.prodi') as $ind => $item)
                                        <option value="{{ $ind }}" @if ($event->id_prodi == $ind)
                                            selected
                                    @endif >{{ $item }}</option>
