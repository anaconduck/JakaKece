        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 anot">
                    <h1>Riwayat Pendaftaran Magang</h1>
                    <hr>
                    <div class="row">
                        <div class="col-md-12" style="border-left: 5px solid rgba(0, 0, 0, 0.075)">
                            @if ($riwayat->count())
                                <div class="row">
                                    @foreach ($riwayat as $data)
                                        ...
                                        <a class="card2 col-sm-4" href="{{ url("/user/riwayat-magang/$data->id") }}">
                            ...
                            @else
                                <div class="container ex">
                                    <h3>Anda belum terdaftar dalam kegiatan magang. <br><a
                                            href="{{ url('/training') }}">Daftar Magang Sekarang!</a></h3>
